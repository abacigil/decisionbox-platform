...
- **Travel domain pack** — Industry domain pack for travel and hospitality platforms. Covers booking conversion funnels, revenue and pricing analysis, and guest retention. Vacation rental category adds host performance and guest satisfaction areas with marketplace-specific prompts and profile schema.
